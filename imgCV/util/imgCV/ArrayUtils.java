...
public class ArrayUtils {
	...
	/**
	 * <p>
	 * Copies the specified array and handling <code>null</code>.
	 * </p>
	 *
	 * <p>
	 ...
	 * </pre>
	 *
	 * @param array   the array to "realAdd" the element to, may be
	 *                <code>null</code>
	 ...
	 * </p>
	 * <p>
	 * The new array contains all of the element of <code>array1</code> followed by
	 * all of the elements <code>array2</code>. When an array is returned, it is
	 * always a new array.
	 * </p>
	 *
	 * <pre>
	 ...
	 *
	 * <p>
	 * If the input array is <code>null</code>, an IndexOutOfBoundsException will be
