...
public final class ShellUtils {
	 ...
	 * @return the task
	 */
//	public static Utils.Task<CommandResult> execCmdAsync(final String command, final boolean isRooted,
...
//	}
	 ...
	 * @return the task
	 */
//	public static Utils.Task<CommandResult> execCmdAsync(final List<String> commands, final boolean isRooted,
//			final Utils.Callback<CommandResult> callback) {
...
//	}
	 ...
	 * @return the task
	 */
//	public static Utils.Task<CommandResult> execCmdAsync(final String[] commands, final boolean isRooted,
//			final Utils.Callback<CommandResult> callback) {
...
//	}
	 ...
	 */
//	public static Utils.Task<CommandResult> execCmdAsync(final String command, final boolean isRooted,
//			final boolean isNeedResultMsg, final Utils.Callback<CommandResult> callback) {
...
//	public static Utils.Task<CommandResult> execCmdAsync(final List<String> commands, final boolean isRooted,
//			final boolean isNeedResultMsg, final Utils.Callback<CommandResult> callback) {
//		return execCmdAsync(commands == null ? null : commands.toArray(new String[] {}), isRooted, isNeedResultMsg,
//				callback);
//	}
	 ...
	 */
//	public static Utils.Task<CommandResult> execCmdAsync(final String[] commands, final boolean isRooted,
//			final boolean isNeedResultMsg, @NonNull final Utils.Callback<CommandResult> callback) {
