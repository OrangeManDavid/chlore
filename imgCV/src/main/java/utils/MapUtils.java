...
public class MapUtils {
	...
	/**
	 * Returns a new read-only map with the specified contents, given as a list of
	 * pairs where the first value is the key and the second is the value.
	 *
	...
	@SafeVarargs
	public static <K, V> TreeMap<K, V> newTreeMap(final Comparator<K> comparator, final Pair<K, V>... pairs) {
		if (comparator == null) {
	...
	public static <K1, V1, K2, V2> Map<K2, V2> transform(Map<K1, V1> map,
			final Transformer<K1, V1, K2, V2> transformer) {
